...
export default function IndustriesHubPage() {
    return (
        <div className="page-wrapper">
            ...
            {/* Industry Grid */}
            <section className={styles.introSection} style={{ paddingBottom: '150px' }}>
                <div className="container">
                    <div className={styles.featureGrid} style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))' }}>

                        {/* Tree Service Card */}
                        <Link href="/industries/tree-service-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                            ...
                            <span className="btn btn-secondary" style={{ marginTop: '20px', fontSize: '0.8rem', padding: '10px 20px' }}>EXPLORE STRATEGY →</span>
                        </Link>

                        {/* Fence Installation Card */}
                        <Link href="/industries/fence-installation-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        <Link href="/industries/custom-home-builder-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        {/* Roofing Card */}
                        <Link href="/industries/roofing-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        {/* HVAC Card */}
                        <Link href="/industries/hvac-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        {/* Epoxy Card */}
                        <Link href="/industries/epoxy-flooring-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        {/* Spray Foam Card */}
                        <Link href="/industries/spray-foam-insulation-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        {/* Land Clearing Card */}
                        <Link href="/industries/land-clearing-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
                        ...
                        <Link href="/industries/mold-remediation-marketing" className={styles.featureCard} style={{ textDecoration: 'none', cursor: 'pointer', display: 'block' }}>
                            <div style={{ position: 'relative', width: '100%', height: '200px', marginBottom: '25px', overflow: 'hidden', border: '1px solid #333' }}>
                                <Image
